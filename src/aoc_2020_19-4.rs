...
pub fn aoc_2020_19() {
    ...
    let ms = sub_rule_1(0, 0, &r, message);
    //println!("{:?}", ms);
    for m in message {
        println!("{}", m.iter().collect::<String>());
    }
    for u in r[&0].iter_mut().enumerate() {
